...
const Winter = () => {
  return (
    <div className="mx-auto container w-full h-[323px] xs:h-[55vh] md:h-[95vh] lg:h-[95vh] xl:h-[323px] bg-[#40465D] text-white relative rounded-[30px] flex items-center xs:justify-center justify-between xl:justify-between xs:flex-col xl:flex-row">
      ...
      <div className="absolute left-[10%] xl:left-[12%] xs:-left-[10px] 2xl:left-[19%] xs:-top-20 md:-top-48 lg:-top-52 xl:-top-[100px] 2xl:-top-[140px]">
