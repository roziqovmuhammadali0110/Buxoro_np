...
const Winter = () => {
  return (
    <div className="mx-auto container w-full h-[323px] xs:h-[70vh] md:h-[90vh] lg:h-[120vh] xl:h-[323px] bg-[#40465D] text-white relative rounded-[30px] flex items-center xs:justify-center justify-between xl:justify-between xs:flex-col xl:flex-row">
