...
const Automn = () => {
  return (
    <div className="mx-auto container w-full h-[323px] xs:h-[70vh] md:h-[90vh] lg:h-[120vh] xl:h-[323px] bg-[#5F5382] text-white mt-20 relative rounded-[30px] flex items-center xs:justify-center justify-between xl:justify-between xs:flex-col xl:flex-row">
